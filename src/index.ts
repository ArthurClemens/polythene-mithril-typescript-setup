...
const linkIconSVG =
  '<svg width="24" height="24" viewBox="0 0 24 24"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"/></svg>';
const iconFavoriteSVG =
...
const navigationList = (navItemClick: (e: Event) => void) =>
  m(List, {
    tiles: [
      {
        title: 'Inbox',
...
const iconRefreshSVG =
  '<svg width="24" height="24" viewBox="0 0 24 24"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>';
const iconAddSVG =
...
const toolbarButton = (svg: object) =>
  m(IconButton, {
    icon: { svg },
  });
...
const App = {
  view: () =>
    m('.page', [
      m('.row', [m('h3', 'Polythene for Mithril built with TypeScript')]),
      m('.row', [m('h6', 'Drawer'), m('.component', m(AppDrawer))]),
      m('.row', [
        m('h6', 'SVG'),
        m(
          '.component',
        ...
        m(
          ...
          m(Menu, {
            ...
            content: m(
              ...
              [m(ListTile, { title: 'Yes' }), m(ListTile, { title: 'No' })],
            ),
          }),
        ),
      ]),
            ...
            content: [
              {
                primary: {
                  ...
                  media: {
                    ...
                    content: m('img', {
                      src:
                        'http://arthurclemens.github.io/assets/polythene/examples/2-unlimited.jpg',
                    }),
                  },
                },
              },
      ...
      m('.row', [m('h6', 'Search'), m('.component', m(SearchField))]),
      m('.row', [
        m('h6', 'Toolbar'),
        m(
          '.component',
